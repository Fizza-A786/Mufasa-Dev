...
export function CTA() {
  return (
    <section className="py-12 sm:py-16 px-4 sm:px-4 reveal-section">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-2">
        <div className="reveal bg-gradient-to-r from-[#111111] to-[#F46F25]/20 rounded-2xl p-6 sm:p-8 md:p-12 flex flex-col lg:flex-row items-center lg:items-center justify-between gap-6 sm:gap-8 border border-[#F46F25]/30">
          ...
          <div className="text-center lg:text-left">
            <h2
              className="text-2xl text-white sm:text-3xl md:text-4xl font-bold uppercase mb-3"
