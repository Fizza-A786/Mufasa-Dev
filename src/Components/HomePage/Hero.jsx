...
export default function Hero() {
  return (
    <section className="py-10 md:py-20 flex items-center relative overflow-hidden pt-24 px-6 lg:px-16 bg-black min-h-[80vh]">
      ...
      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-10 md:gap-14 items-center relative z-10">
        ...
        <div className="max-w-xl mx-auto lg:mx-0 text-center lg:text-left">
          ...
          <div className="inline-block mt-6 px-5 py-2 bg-[#F46F25]/10 border border-[#F46F25]/30 rounded-full">
            <span className="text-[#F46F25] text-[10px] sm:text-[11px] uppercase tracking-widest font-semibold">
              Welcome to Mufasa Developers
            </span>
          </div>

          <h1 className="text-white font-bold leading-[1.1] mb-6 text-[clamp(30px,6vw,60px)] mt-8 md:mt-10">
            <span className="block mb-1">Build Skills.</span>
            <span className="block mb-1">Earn Online.</span>
            <span className="text-[#F46F25] whitespace-nowrap">
              Work with Mufasa.
            </span>
          </h1>

          <p className="text-gray-400 text-sm sm:text-base mb-6 md:mb-10 max-w-md mx-auto lg:mx-0 leading-relaxed">
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-4">
            ...
            <Link
              to="/blog"
              className="px-6 sm:px-7 py-3 border border-[#F46F25] text-[#F46F25] rounded-lg hover:text-white hover:scale-110 transition-all duration-300 text-sm font-medium hover:bg-[#F46F25]"
            >
              Explore Blog
            </Link>
          </div>
        ...
        <div className="flex justify-center relative mt-10 lg:mt-0">
          ...
          <div className="relative w-full max-w-[320px] sm:max-w-[380px] md:max-w-[420px] aspect-square rounded-3xl bg-gradient-to-br from-[#F46F25] to-[#d65a1c] flex items-center justify-center shadow-[0_30px_100px_rgba(244,111,37,0.4)] overflow-hidden">
